Hey This is a simple Admin Panel which stores and manipulates the employees' data in the database. <br>This project uses Flask framework as the backend and Bootstrap and JS for on-page manipulation.<br>
